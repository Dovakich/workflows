...
// ── Вимикаємо апаратне прискорення (виправляє GPU crash на Windows) ─────────
...
log.transports.console.level = 'warn'; // менше шуму в консолі
...
function setupIPC() {
  ...
  // ── Запуск гри ────────────────────────────────────────────────────────────
  // ВАЖЛИВО: знімаємо старі слухачі перед кожним запуском (щоб не накопичувались)
